...
<body class="container py-4">
  <h1 class="mb-4">Création d'un nouvel article</h1>
  ...
  <form method="post" class="row g-3">
    ...
    <div class="col-12">
      ...
      <textarea name="article_text" id="article_text" class="form-control"></textarea>
    </div>

    <div class="col-md-6">
      <label for="article_date" class="form-label">Date :</label>
      <input type="datetime-local" name="article_date" id="article_date" class="form-control">
    </div>

    <div class="col-md-6 form-check mt-4">
      <input type="checkbox" name="article_visibility" id="article_visibility" value="1" checked class="form-check-input">
