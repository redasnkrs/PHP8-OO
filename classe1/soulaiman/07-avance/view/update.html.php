...
<div class="container-content">
    ...
    <h2>Modifier l'article existant</h2>
    ...
    <form action="" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="article_title" id="article_title" value="<?= html_entity_decode($article->getArticleTitle()) ?>" required>
        </div>

        <div class="mb-3">
            <label for="article_text">Texte de l'article</label>
            <textarea name="article_text" id="article_text" cols="30" rows="10" required><?= html_entity_decode($article->getArticleText()) ?></textarea>
        </div>

        <div class="mb-3">
            <label for="article_date">Date de l'article</label>
            <input type="datetime-local" name="article_date" id="article_date" value="<?= $article->getArticleDate() ?>" required>
        </div>
