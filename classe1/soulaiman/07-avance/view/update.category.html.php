...
<div class="container-content mt-5">
    ...
    <h2>Modifier les informations de la catégorie</h2>
    ...
    <form action="" method="post">
        ...
        <input type="text" name="category_name" id="category_name" value="<?= html_entity_decode($category->getCategoryName()) ?>" required>

        <label for="category_desc">Description de la catégorie</label>
        <textarea name="category_desc" id="category_desc" rows="6" required><?= html_entity_decode($category->getCategoryDesc()) ?></textarea>
