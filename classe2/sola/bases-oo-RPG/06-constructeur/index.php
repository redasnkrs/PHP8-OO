...
<?php
echo 'La marque de notre $car1 ($car1->getMarque()) : ' .
    "{$car1->getMarque()}<br>";
echo 'La marque de notre $car2 (htmlspecialchars($car2->getMarque())) contient une attaque XSS, si vous ne savez pas d\'où viennent les données, protégées les à l\'affichage : ' .
    htmlspecialchars($car2->getMarque()) .
    "<br>";
?>
<h3>Les setters</h3>
