...
$car3 = new LaVoiture("BMW",2008,150,"E46");
...
<?php
foreach ([$car1,$car2,$car3] as $car){
    echo "Marque : {$car->getMarque()} | Année : {$car->getAnneeSortie()} | Chevaux : {$car->getChevaux()} | Modèle : {$car->getModel()}<br>";
}
